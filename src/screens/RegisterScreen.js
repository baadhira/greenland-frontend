    ...
    <FormContainer>
     ...
     <Form.Group controlId="password">
      ...
      <Form.Group controlId="confirmPassword">
                    ...
                    <Form.Control required type='Password' placeholder="Enter Password Again" value={confirmPassword} onChange={(e)=>setConfirmPassword(e.target.value)}>
        ...
        <Row className="py-3">
            <Col>
            Have an acccount? <Link to={redirect?`/login?redirect=${redirect}`:'/login'}>Sign In</Link>
            </Col>
        </Row>
